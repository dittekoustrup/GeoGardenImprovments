...
<template>
  <main>
    ...
    <IntroSubscription title="Velkommen til haven"
      ...
      buttonText="Læs mere" :buttonAlt=true imageURL="../assets/gfx/logo/Logo_icon_no_text.svg" />
    ...
    <IntroSubscription title="Bliv en del af klubben"
      ...
      buttonText="Bliv medlem" imageURL="../assets/images/mobile/Kundeklub_kort.webp" :buttonAlt=true />
